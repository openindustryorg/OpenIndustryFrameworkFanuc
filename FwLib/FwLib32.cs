...
public class Focas1
{
    ...
    public class ALM_HIS5_data
    {
        ...
        public int[] g_modal;        /* G code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public char[] g_dp;           /* #7:1 Block  #6`#0 dp */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public int[] a_modal;        /* B,D,E,F,H,M,N,O,S,T code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public char[] a_dp;           /* #7:1 Block  #6`#0 dp */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public int[] abs_pos;        /* Abs pos */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public char[] abs_dp;         /* Abs dp */
    ...
    public static extern short cnc_rdpdf_drive(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] ODBPDFDRV a);
    ...
    /* read custom macro variable */
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdmacro")]
    public static extern short cnc_rdmacroe(ushort FlibHndl, short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBME c);
    ...
    /* Linux Set logfile information */
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_startupprocess")]
    public static extern short cnc_startupprocess(short level, 
        [In, MarshalAs(UnmanagedType.LPArray)]  char[] filename);
